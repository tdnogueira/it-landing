        ...
        <main className="max-w-5xl mx-auto p-6 space-y-16">
          <section className="text-center py-16">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Consultoria de carreira e educação financeira para jovens que
              querem transformar o futuro
            </p>
          </section>
          ...
          <section id="sobre" className="space-y-2">
            ...
            <p>
              Somos uma plataforma dedicada a preparar jovens para os desafios
              do mercado de trabalho com orientação de carreira, planejamento
          ...
          <section id="valores" className="space-y-2">
            ...
            <ul className="list-disc ml-6">
              ...
              <li>
                <strong>Visão:</strong> Ser referência em preparação
                profissional para a juventude.
              </li>
              <li>
                <strong>Valores:</strong> Acolhimento, inovação, acessibilidade
                e ética.
              </li>
            </ul>
          </section>
